 ...
 * como base para resolver este ejercicio, no tiene mucho de especial
 * en la parte de abajo explico el ejercicio.
*/
...
/**
 * Debe resolver un sistema de ecuaciones (matriz1)
 * Debe invertir una matriz (matriz2)
 * Debe calcular el determinante de una matriz (matriz3)
 * 
 * Para lo anterior es necesario aplicar la eliminación gaussiana enseñada
 * en algebra y geometría 2 y visto su algoritmo en el PDF del profesor Toledo
*/
